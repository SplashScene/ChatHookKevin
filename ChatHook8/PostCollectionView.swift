...
class PostCollectionView: UICollectionViewCell {
    ...
    func setupDescriptionTextShowcaseImage(){
        ...
        likesLabel.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 8).isActive = true
    ...
    func setupCommentSection(){
        ...
        separatorLineView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: -24).isActive = true
